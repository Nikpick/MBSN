...
public:
	...
	static std::shared_ptr<Modeling::BaseType> real = std::make_shared<Modeling::BaseType>("Real");
	static std::shared_ptr<Modeling::BaseType> integer = std::make_shared<Modeling::BaseType>("Integer");
	static std::shared_ptr<Modeling::BaseType> stringa = std::make_shared<Modeling::BaseType>("String");
	static std::shared_ptr<Modeling::BaseType> boolean = std::make_shared<Modeling::BaseType>("Boolean");
