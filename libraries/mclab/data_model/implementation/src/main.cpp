...
#include <iostream>
#include "utils/exceptions/NoPHMLInputException.cpp"

int main(int argc, char* argv[]) {
    std::unordered_map<std::string, std::shared_ptr<Modeling::Module>> modules;
    modules.insert(std::pair<const char *, std::shared_ptr<Modeling::Module>>("system", std::make_shared<Modeling::Module>("system")));
